...
interface GoogleAutocomplete2Props extends InputFieldProps {
	label?: string
	onPlaceSelected?: (place: google.maps.places.PlaceResult) => void
}

const GoogleAutocomplete2 = forwardRef<InputFieldProps, GoogleAutocomplete2Props>(
	({ label, onChange, onPlaceSelected, value, name, ...rest }, forwardRef) => {
		...
		return (
			<>
				{openPrediction && (
					<div className="opacity-25 h-screen w-sreen fixed inset-0 z-[90]" onClick={() => setOpenPrediction(false)} />
				)}
