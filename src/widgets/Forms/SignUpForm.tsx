...
import { Button, DialogActions, Grid, MenuItem, TextField, Select, Container } from '@mui/material'
				...
				<Grid container direction="column" rowSpacing={3}>
					...
					<Grid item>
						<Controller
							...
							control={control}
							render={({ field }) => (
								<TextField label={t('Email')} placeholder={t('Enter email')} fullWidth {...field} />
							)}
						/>
					</Grid>
					<Grid item>
